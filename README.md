...
~~~sh
git clone https://github.com/carlosaugusto-dev/Projeto-integrador-transdiciplinar-2.git
~~~
...
- **Link da Solução em Funcionamento:** [cupcake-site](https://cupcakesdocarlos.free.nf)
...
- **Loja:**:
- ![Loja](https://github.com/carlosaugusto-dev/Projeto-integrador-transdiciplinar-2/blob/main/documentos/loja.jpg?raw=true)

- - **Painel de Admin:**
- ![Painel de Admin](https://github.com/carlosaugusto-dev/Projeto-integrador-transdiciplinar-2/blob/main/documentos/admin.jpg?raw=true)
